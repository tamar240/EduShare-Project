...
//       {/* Delete Dialog */}
//       <Dialog open={deleteDialog.open} onClose={() => setDeleteDialog({ open: false, file: null, type: "lesson" })}>
//         <DialogTitle sx={{ display: "flex", alignItems: "center", gap: 1 }}>
//           <WarningIcon color="error" />
//           אישור מחיקה
//         </DialogTitle>
//         <DialogContent>
//           <DialogContentText>האם אתה בטוח שברצונך למחוק את הקובץ "{deleteDialog.file?.fileName}"?</DialogContentText>
//           <Typography
//             variant="body2"
//             sx={{
//               color: "#856404",
...
//             }}
//           >
//             הקןבץ יועבר לסל המיחזור
//           </Typography>
//         </DialogContent>
//         <DialogActions>
//           <Button onClick={() => setDeleteDialog({ open: false, file: null, type: "lesson" })}>ביטול</Button>
//           <Button
